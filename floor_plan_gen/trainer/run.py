...
from floorgen.core import data_sources
from floorgen.trainer.models import BiCycleGAN, Pix2Pix
...
def run(conf):
  ...
  conf["settings"]["storage_location"] = str(
    ...
    f"Storage diectory has been update to {conf['settings']['storage_location']}."
  )
