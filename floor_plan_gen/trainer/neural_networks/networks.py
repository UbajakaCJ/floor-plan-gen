...
from floorgen.trainer.neural_networks.patchgan import create_patchgan
from floorgen.trainer.neural_networks.residual import create_residual_network
from floorgen.trainer.neural_networks.unet import create_unet
